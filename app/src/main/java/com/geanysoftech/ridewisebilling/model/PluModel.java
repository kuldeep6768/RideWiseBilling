...
public class PluModel implements Serializable {
    ...
    public PluModel(String pluName, String price) {
        this.pluName = pluName;
        this.price = price;
    }

    public PluModel(String id, String pluCode, String pluName, String pluType, String hsn, String price, String deposit, String eventTypeID, String resourceID, String eventID,
                    String quantity, String discountPercent, String discountAmount, List<PluTaxesModel> taxes, List<PluChildItemsModel> childItems, String totalAmount) {
        this.id = id;
